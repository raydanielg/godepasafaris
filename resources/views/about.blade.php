...
<head>
    ...
    @include('partials.seo', [
        'seoTitle' => 'About Go Deep Africa Safari | Locally-Owned Tanzania Safari Experts in Arusha',
        'seoDescription' => 'Meet Go Deep Africa Safari, a locally-owned Arusha team crafting authentic Tanzania safaris and Kilimanjaro treks while supporting local communities. Our story, values and expert guides.',
    ])
    <!-- Fonts -->
