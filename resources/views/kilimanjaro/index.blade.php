...
<head>
    ...
    <title>Kilimanjaro Trekking - Go Deep Africa Safari</title>
    ...
    <section class="py-5 bg-light">
        <div class="container py-5">
            <div class="text-center mb-5 animate__animated animate__fadeIn">
                <p class="section-subtitle">Breathtaking views, unique wildlife encounters, and the satisfaction of reaching Africa's highest summit.</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 animate__animated animate__fadeInUp">
                    <div class="package-card h-100 rounded-4 overflow-hidden border-0 shadow-sm bg-white">
                        <a href="{{ route('kilimanjaro.show', $pkg->slug) }}" class="text-decoration-none">
                            <div class="package-img-wrapper" style="height: 220px; position: relative; overflow: hidden;">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <a href="{{ route('kilimanjaro.show', $pkg->slug) }}" class="text-decoration-none">
                                <h5 class="fw-bold mb-4 text-dark hover-primary" style="font-family: 'Playfair Display', serif; min-height: 3rem;">{{ $pkg->title }}</h5>
                            </a>
