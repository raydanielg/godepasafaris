...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Update details for: {{ $destination->name }}</p>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded-4 p-4 mb-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg rounded-3 @error('name') is-invalid @enderror" placeholder="e.g. Serengeti National Park" value="{{ old('name', $destination->name) }}" required>
                        @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark">Description</label>
                        <textarea name="description" id="editor-description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $destination->description) }}</textarea>
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0 rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="location" class="form-control rounded-3 @error('location') is-invalid @enderror" placeholder="e.g. Northern Tanzania" value="{{ old('location', $destination->location) }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="type" class="form-select rounded-3 @error('type') is-invalid @enderror" required>
                            ...
                            <option value="Beach" {{ old('type', $destination->type) == 'Beach' ? 'selected' : '' }}>Beach</option>
