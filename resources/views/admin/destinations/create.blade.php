            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded-4 p-4 mb-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" class="form-control form-control-lg rounded-3 @error('title') is-invalid @enderror" placeholder="e.g. Zanzibar" value="{{ old('title') }}" required>
                        @error('title') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark">Short Description</label>
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="A brief overview of the destination...">{{ old('description') }}</textarea>
                        @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark">Detailed Content (Storytelling)</label>
                        <textarea name="rich_content" id="editor-rich-content" class="form-control @error('rich_content') is-invalid @enderror">{{ old('rich_content') }}</textarea>
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="map_iframe" class="form-control @error('map_iframe') is-invalid @enderror" rows="4" placeholder="Paste Google Maps iframe code here...">{{ old('map_iframe') }}</textarea>
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0 rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="category" class="form-control rounded-3 @error('category') is-invalid @enderror" placeholder="e.g. Tanzania" value="{{ old('category') }}" required>
                        @error('category') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark">Rate Range</label>
                        <input type="text" name="rate_range" class="form-control rounded-3 @error('rate_range') is-invalid @enderror" placeholder="e.g. $120 to $2820" value="{{ old('rate_range') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="best_time" class="form-control rounded-3 @error('best_time') is-invalid @enderror" placeholder="e.g. June to October" value="{{ old('best_time') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="high_season" class="form-control rounded-3 @error('high_season') is-invalid @enderror" placeholder="e.g. July to October" value="{{ old('high_season') }}" required>
