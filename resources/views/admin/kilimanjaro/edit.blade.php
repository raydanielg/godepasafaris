...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">Edit Kilimanjaro Package</h1>
    ...
    <form action="{{ route('admin.kilimanjaro.update', $package) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded-4 p-4 mb-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" class="form-control form-control-lg rounded-3 @error('title') is-invalid @enderror" placeholder="e.g. 7 Days Machame Route" value="{{ old('title', $package->title) }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="itinerary" id="editor-itinerary" class="form-control @error('itinerary') is-invalid @enderror">{{ old('itinerary', $package->itinerary) }}</textarea>
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0 rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="route_name" class="form-control rounded-3 @error('route_name') is-invalid @enderror" placeholder="e.g. Machame, Lemosho" value="{{ old('route_name', $package->route_name) }}" required>
                    ...
                    <div class="row">
                        <div class="col-6 mb-4">
                            ...
                            <input type="number" name="days" class="form-control rounded-3 @error('days') is-invalid @enderror" placeholder="7" value="{{ old('days', $package->days) }}" required>
                        ...
                        <div class="col-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price" class="form-control rounded-end-3 @error('price') is-invalid @enderror" placeholder="0" value="{{ old('price', $package->price) }}" required>
                            </div>
                    ...
                    <button type="submit" class="btn btn-earth w-100 py-3 rounded-pill fw-bold text-white shadow-sm" style="background-color: #8b4513;">
                        <i class="fas fa-save me-2"></i>Update Trek
                    </button>
                </div>
            </div>
        </div>
