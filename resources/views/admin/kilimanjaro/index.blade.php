...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold">Kilimanjaro Packages</h3>
        ...
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="px-4">
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ asset($package->image) }}" class="rounded-3 object-fit-cover" width="50" height="50" onerror="this.src='https://placehold.co/50x50?text=Kili'">
                                <div>
                        ...
                        <td><span class="small">{{ $package->route_name ?? 'N/A' }}</span></td>
                        <td><span class="small">{{ $package->days ?? '7' }} Days</span></td>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center py-5 text-muted">No Kilimanjaro packages found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
