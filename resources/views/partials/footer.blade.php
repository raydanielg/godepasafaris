        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-brand mb-4">
                    ...
                    <div class="footer-socials-new d-flex gap-2 mt-4">
                        ...
                        <a href="https://www.instagram.com/godeepafricasafariexpendition?igsh=MWpxc25icmkzZDA3Mg==" target="_blank" class="social-circle" title="Instagram"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.tiktok.com/@godeepafrica.safari?_r=1&_t=ZS-96aUetd9NMF" target="_blank" class="social-circle" title="TikTok"><i class="fab fa-tiktok"></i></a>
                        <a href="https://www.threads.com/@godeepafricasafariexpendition" target="_blank" class="social-circle" title="Threads"><i class="fa-brands fa-threads"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled footer-links-new">
                    ...
                    <li><a href="{{ route('zanzibar') }}"><i class="fas fa-chevron-right me-2"></i>Zanzibar</a></li>
                </ul>
            </div>
