            ...
            <div class="modal-header border-0 bg-earth text-white p-4 rounded-top-4">
                <div class="d-flex align-items-center gap-3">
                    <div class="bg-white rounded-circle d-flex align-items-center justify-content-center" style="width: 45px; height: 45px;">
                        <i class="fas fa-paper-plane text-earth"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold mb-0" id="generalInquiryModalLabel">Plan Your Dream Adventure</h5>
                        <small class="opacity-75">Tell us what you're looking for, and we'll craft it for you.</small>
                    </div>
                </div>
